...
if args.run_name == 'None':
    run_name = f"{args.dataset}_{args.privilege_mode}_{args.model}_{args.prepost}_{args.fairness_metric}_{args.target}_single"
else:
    run_name = args.run_name
run_path = f'results/{run_name}/{SEED}/'

# Define the SMAC Run with all the arguments
SMAC_RUN = ['python3', 'train_single.py',
